...
/** 필수 특성 중 '총 참여횟수' 의 id */
export const ESSENTIAL_TRAIT_PARTICIPATION_NUM_ID = 1
/** 필수 특성 중 '참여시각' 의 id */
...
export const ESSENTIAL_TRAIT_PARTICIPATION_NUM_LABEL = '총 참여횟수'
...
export const ESSENTIAL_TRAIT_PARTICIPATION_NUM_INIT: TraitType = {
	id: ESSENTIAL_TRAIT_PARTICIPATION_NUM_ID,
	label: ESSENTIAL_TRAIT_PARTICIPATION_NUM_LABEL,
	hasOption: false,
	options: [],
	value: '',
	valueIdx: -1
